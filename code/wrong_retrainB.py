...
for f in range(len(datafilename_lst)):
    ...
    for i in range(5):
        ...
        print("random select............................%d" %i)
        #length_of_wrong=int(length_of_order-length_of_order*origin_acc)
        testwrong_acc, __,__ = retrain(filename,wrong =True,samplesize=length_of_wrong)
        lstwrong_acc.append(testwrong_acc)
        
        
    resultfilename = '../wrong_resultB.txt'
    with open(resultfilename,'a') as file_object:
        ...
        file_object.write(str(lstwrong_acc))
        file_object.write('\n')
